...
import com.example.videocallapp.signup.SignUpScreen
...
class MainActivity : FragmentActivity() {
    ...
    fun initZegoInviteService(appID: Int, appSign: String, userID: String, userName: String) {
        ...
        ZegoUIKitPrebuiltCallService.init(
            application, appID.toLong(), appSign, userID, userName, callInvitationConfig
        )
